{ lib, fetchFromGitHub, fetchYarnDeps, noriskclient-launcher }:

noriskclient-launcher.override (oldAttrs: { 
  noriskclient-launcher-unwrapped = (oldAttrs.noriskclient-launcher-unwrapped.overrideAttrs (oldAttrs: 
    let
      version = "0.6.19";
      src = fetchFromGitHub {
        owner = "NoRiskClient";
